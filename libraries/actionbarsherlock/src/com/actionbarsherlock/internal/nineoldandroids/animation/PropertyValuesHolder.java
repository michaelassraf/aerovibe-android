	...
	private Method getPropertyFunction(Class targetClass, String prefix, Class valueType) {
		...
		if (valueType == null) {
			try {
				...
				Log.e("PropertyValuesHolder", targetClass.getSimpleName() + " - " + "Couldn't find no-arg method for property " + mPropertyName + ": " + e);
			}
		} else {
			args = new Class[1];
			Class typeVariants[];
			...
			Log.e("PropertyValuesHolder", "Couldn't find " + prefix + "ter property " + mPropertyName + " for " + targetClass.getSimpleName() + " with value type " + mValueType);
		}
